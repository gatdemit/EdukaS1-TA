                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        @else
                                            <form action="/adPanel/quiz/{{ $video['Video'] }}/edit">
                                                <input type="hidden" name="jurusan" id="jurusan" value="{{ Str::replace(' ', '_', $video['Jurusan']) }}">
                                                <button class="btn btn-warning rounded-pill"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-vector-pen" viewBox="0 0 16 16">
                                            ...
                                            <form action="/adPanel/quiz/{{ $video['Video'] }}" method="POST">
                                                ...
                                                <input type="hidden" name="video" id="video" value="{{ $video['Video'] }}">
                                                <input type="hidden" name="jurusan" id="jurusan" value="{{ Str::replace(' ', '_', $video['Jurusan']) }}">
                                                <button class="btn btn-danger rounded-pill mt-2" onclick="return confirm('Are you sure?')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
