...
@section('container')
    <div class="row mt-5">
        <div class="col-5 offset-1" style="margin-right: 40px;">
        ...
        <div class="col-5">
            <img src="{{ asset('storage/asset/About_1.jpeg') }}" alt="" style="width: 500px; height: 500px;">
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-5 offset-1" style="margin-right: 40px;">
            <img src="{{ asset('storage/asset/About_2.jpeg') }}" alt="" style="width: 500px; height: 500px;">
        </div>
        <div class="col-5">
